...
class TestKrrModels:
    ...
    def test_krr_recommendation_impact_calculation(self):
        ...
        from src.recommender.models import KrrRecommendation, KubernetesObject, ResourceValue
    ...
    def test_cpu_parsing(self):
        ...
        rec = KrrRecommendation(
            object=KubernetesObject(kind="Deployment", name="test", namespace="default"),
