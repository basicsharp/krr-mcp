...
class TestSafetyValidator:
    ...
    def test_validate_high_memory_increase(self):
        ...
        # Should have a warning about exceeding limits
        memory_warnings = [w for w in assessment.warnings if "Memory increase" in w.message]
    ...
    def test_validate_critical_workload(self):
        ...
        critical_warnings = [w for w in assessment.warnings if "critical workload" in w.message]
    ...
    def test_validate_production_namespace(self):
        ...
        prod_warnings = [w for w in assessment.warnings if "production namespace" in w.message]
    ...
    def test_validate_extreme_cpu_increase(self):
        ...
        limit_warnings = [w for w in assessment.warnings if "CPU increase" in w.message and "exceeds maximum" in w.message]
        extreme_warnings = [w for w in assessment.warnings if "Extreme resource changes" in w.message]
    ...
    def test_validate_many_simultaneous_changes(self):
        ...
        bulk_warnings = [w for w in assessment.warnings if "Large number of simultaneous changes" in w.message]
    ...
    def test_validate_multiple_production_namespaces(self):
        ...
        multi_prod_warnings = [w for w in assessment.warnings if "multiple production namespaces" in w.message]
    ...
    def test_critical_workload_patterns(self):
        ...
        for name in critical_names:
            ...
            assessment = validator.validate_changes(changes)
            assert assessment.critical_workloads_affected >= 1, f"Failed to detect critical workload: {name}"
    ...
    def test_production_namespace_patterns(self):
        ...
        for namespace in production_namespaces:
            ...
            assessment = validator.validate_changes(changes)
            assert namespace in assessment.production_namespaces_affected, f"Failed to detect production namespace: {namespace}"